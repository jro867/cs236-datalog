 ...
 */
enum TokenType {COMMA, PERIOD, COLON_DASH, STRING, Q_MARK,LEFT_PAREN,RIGHT_PAREN, COLON, MULTIPLY,ADD,ID, SCHEMES, FACTS, QUERIES, RULES, COMMENT, UNDEFINED,NUL, EOF};
