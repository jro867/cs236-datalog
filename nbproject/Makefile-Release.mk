...
${OBJECTDIR}/DatalogProgram.o: DatalogProgram.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/DatalogProgram.o DatalogProgram.cpp
...
${OBJECTDIR}/FactList.o: FactList.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/FactList.o FactList.cpp

${OBJECTDIR}/HeadPredicate.o: HeadPredicate.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/HeadPredicate.o HeadPredicate.cpp

${OBJECTDIR}/IdList.o: IdList.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/IdList.o IdList.cpp
...
${OBJECTDIR}/ParameterList.o: ParameterList.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/ParameterList.o ParameterList.cpp

${OBJECTDIR}/ParsingException.o: ParsingException.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/ParsingException.o ParsingException.cpp

${OBJECTDIR}/Predicate.o: Predicate.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/Predicate.o Predicate.cpp

${OBJECTDIR}/PredicateList.o: PredicateList.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/PredicateList.o PredicateList.cpp
...
${OBJECTDIR}/QueryList.o: QueryList.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/QueryList.o QueryList.cpp
...
${OBJECTDIR}/StringList.o: StringList.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/StringList.o StringList.cpp
